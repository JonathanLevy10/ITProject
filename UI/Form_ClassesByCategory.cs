...
{
    public partial class Form_ClassesByCategory : Form
    {
        public Form_ClassesByCategory()
        {
            InitializeComponent();
            Graph1();
        }
        ...
        public void Graph1()
        {
            ...
            pArr.Fill();
            CategoryArr cArr = new CategoryArr();
            cArr.Fill();
            string[] Arr = new string[cArr.Count];
            for (int i = 0; i < cArr.Count; i++)
                Arr[i] = (cArr[i] as Category).Name;
